...
Public Class File
	...
	Public Property Name() As String
		...
		End Set
	End Property
	Public Function OpenAsTextStream(Optional IOMode As FileSystemObject.IOMode = FileSystemObject.IOMode.ForReading, Optional Format As FileSystemObject.Tristate = FileSystemObject.Tristate.TristateFalse) As TextStream
		Try
			OpenAsTextStream = Me.Obj.OpenAsTextStream(IOMode, Format)
			Me.ClearErr()
		Catch ex As Exception
			Me.SetSubErrInf("OpenAsTextStream", ex)
			Return Nothing
		End Try
	End Function
